...
struct EpisodesDataManager {
    ...
    static func load(programId: String, completion: (EpisodesDataManager) -> ()) throws {
        ...
        // TEST
        item2VideoId[transferEpisode] = transferVideoId
        
        //
        let data = EpisodesDataManager(seasonsNum: seasonsNum, episodesNums: episodesNums, item2VideoId: item2VideoId)
        completion(data)
    }
